...
- **AI 助手** — 多模型 AI 对话（OpenAI / Claude / DeepSeek / Groq / Ollama）；流式输出，支持配置和管理多个模型
...
- **工具栏自定义** — 在设置中单独开关各工具按钮（AI、扩展、书签、历史、下载、阅读、笔记）；默认仅启用：AI、书签、历史、下载
- **检查更新** — 检测 GitHub 最新版本
- **右键菜单** — 右键提供导航、图片操作（复制图片、复制链接、查看图片）、打印、截图
