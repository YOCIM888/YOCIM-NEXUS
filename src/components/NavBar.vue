...
defineEmits(['back', 'forward', 'reload', 'navigate', 'input', 'blur', 'update:urlInput', 'selectSuggestion', 'toggleBookmark', 'addToReadingList', 'togglePanel', 'toggleReadingList', 'toggleNotes', 'toggleExtensions', 'enterPip', 'openSettings'])
